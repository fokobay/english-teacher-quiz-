...
# BUG FIX: Lazy singletons were not protected by a lock.  Two group threads
# starting simultaneously could both see _tracker as None and create duplicate
# instances, causing double-initialization and potential config races.
